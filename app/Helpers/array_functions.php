...
function bankNamesDropdown($bank_name = null)
{
    $bank_name_array = [
        1 => 'Sonali Bank',
        2 => 'Janata Bank',
...
function maritalStatusesDropdown($marital_status = null)
{
...
function bloodGroupsDropdown($blood_group = null)
{
    $blood_group_array = [
        1 => 'A+',
        2 => 'A-',
...
function departmentsDropdown($department = null)
{
    $department_array = [
        1 => 'Management',
        2 => 'Marketing',
...
function designationsDropdown($designation = null)
{
    $designation_array = [
        1 => 'CEO',
        2 => 'Manager',
